...
Firstly, you will want to go to the styles folder, which is located in the root of the project when you clone it with git.
...
```bash
GTK_DEBUG=interactive ./target/release/gray-meadows-shell
```